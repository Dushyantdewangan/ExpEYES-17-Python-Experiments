...
if 'Windows' in pf:
	...
	import sr04dist, utils, logger, XYplot, i2cLogger, tof, advanced_logger, blockcoding, circuitjs, multiplexedlogger,single_channel_logger
...
class MainWindow(QMainWindow):
	...
	def makeMenu(self):
		...
		mb.addAction(self.tr('Open Stepper Controller'), self.newStepperController)
