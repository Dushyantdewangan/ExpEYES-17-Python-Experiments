...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_4.clicked.connect(Dialog.restartLogging)
        self.pauseButton.clicked['bool'].connect(Dialog.pauseLogging)
        self.pushButton_6.clicked.connect(Dialog.saveTraces)
        self.durationBox.editingFinished.connect(Dialog.setDuration)
